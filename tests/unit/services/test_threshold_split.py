...
Test matrix:
  ...
  T11 paper=0.45, live=0.60: gap=0.15 — violates +0.20 invariant (must raise)
  T12 paper=0.40, live=0.65: gap=0.25 — satisfies +0.20 invariant (must pass)
"""
...
# ---------------------------------------------------------------------------
# T1 — paper flag → paper thresholds (0.35)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# T2 — live mode → live thresholds (0.60)
# ---------------------------------------------------------------------------
...
# paper=0.50, live=0.65: gap=0.15 — violates the +0.20 invariant.
# ---------------------------------------------------------------------------
def test_fat_finger_signal_threshold_assert(monkeypatch, tmp_path):
    ...
    bad_yaml.write_text(
        ...
        "    min_confidence: 0.35\n"
        "  live:\n"
        "    signal_threshold: 0.65\n"   # gap=0.15 — violates +0.20 invariant
        "    min_confidence: 0.60\n"
    )
    import src.services.live_trading_service as svc_mod
...
# paper mc=0.50, live mc=0.65: gap=0.15 — violates the +0.20 invariant.
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# T7 — YAML missing → coded defaults (0.35/0.35), no crash, source="default"
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# T11 — pre-Phase6 baseline: paper=0.45, live=0.60, gap=0.15
#        MUST raise under the new +0.20 invariant.
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# T12 — paper=0.40, live=0.65: gap=0.25 — satisfies the +0.20 invariant.
# ---------------------------------------------------------------------------
