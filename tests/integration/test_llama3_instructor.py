"""
Integration Test: llama3.1:8b with Instructor Library.

Tests the llama3.1:8b model using the instructor library for guaranteed
...
- Response time <10s for 8B model
"""
...
def main():
    """Test llama3.1:8b with instructor library."""

    print("\n" + "╔" + "="*78 + "╗")
    print("║" + " "*23 + "llama3.1:8b with Instructor Library" + " "*21 + "║")
    print("║" + " "*16 + "Success Criterion: 50%+ variance across scenarios" + " "*15 + "║")
    print("╚" + "="*78 + "╝\n")

    # Import the instructor client
    ...
    for i, scenario in enumerate(scenarios, 1):
        ...
        try:
            ...
            print(f"\n{'='*80}")
            print(f"❌ {model_name} FAILED at {scenario.name}")
            print(f"{'='*80}\n")
            return
