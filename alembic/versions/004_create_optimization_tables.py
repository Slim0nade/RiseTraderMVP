...
Revision ID: 004_optimization_tables
Revises: 003_add_max_candles_to_backtest_config
...
revision: str = '004_optimization_tables'
down_revision: Union[str, None] = '003_add_max_candles_to_backtest_config'
